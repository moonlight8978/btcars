(function() {
    ...
    CartController.$inject = ['$localStorage', '$uibModalInstance', 'CartService', 'getCarFactory', 'Customer', 'car'];

    function CartController ($localStorage, $uibModalInstance, CartService, getCarFactory, Customer, car) {
        var vm = this;
