...
public class Car implements Serializable {
    ...
    @JsonIgnore
    private Set<Customer> carts = new HashSet<>();
    ...
    public Set<Customer> getCarts() {
        return carts;
    }

    public Car carts(Set<Customer> customers) {
        this.carts = customers;
        return this;
    }

    public Car addCart(Customer customer) {
        this.carts.add(customer);
        customer.getCarts().add(this);
        return this;
    }

    public Car removeCart(Customer customer) {
        this.carts.remove(customer);
        customer.getCarts().remove(this);
        return this;
    }

    public void setCarts(Set<Customer> customers) {
        this.carts = customers;
    }
